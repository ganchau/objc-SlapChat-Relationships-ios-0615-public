...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    Recipient *recipient = self.dataStore.recipients[indexPath.row];
    
    cell.textLabel.text = recipient.name;
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%lu", recipient.messages.count];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    FISTableViewController *messageDVC = segue.destinationViewController;
    NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
    Recipient *recipient = self.dataStore.recipients[indexPath.row];
    messageDVC.messages = [recipient.messages allObjects];
}
